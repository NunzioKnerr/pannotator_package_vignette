---
title: "Introduction to pannotator package"
author:
  - name: "Nunzio Knerr"
  - name: "Robert Godfree"
date: 'today'
...
```{r echo=FALSE, eval=FALSE, results='hold', warning=FALSE, include=TRUE}
...
if(check_for_package == "") {
  ...
  install.packages("exiftoolr")} else {
...
You must also install the 'remotes' package which we will use to install the development version of the pannotator package.
...
if(check_for_package == "") {
  print("package not found .....installing now")
  install.packages("remotes")} else {
  print("package already installed")  
  }
```

You can now install the development version of the pannotator package.
...
![Example layout of the pannotator package loaded with a .kmz file (left) and an individual image (centre).](Images/Figure1.png){fig-align="center" width="95%"}
...
![Main Settings (left and centre) and Lookups (right). The Lookups are tables that appear as dropdown menus in the Annotation Panel and are used to add data annotations to images, markers and drawn geometries.](Images/Figure2.png){fig-align="center" width="95%"}
...
![Example .csv lookup files; user name (left) and general lookup variable, in this case plant species (right).](Images/Figure3.png){fig-align="center" width="95%"}
...
![Mapping window (left) with overlay function (right).](Images/Figure4.png){fig-align="center" width="95%"}
...
![Tools for (A) distance and area measurement and addition of (B) point markers, (C) rectangles, and (D) polygons. The location of an example whole image annotation marker, which can be added in the Annotation Panel, is shown in (E).](Images/Figure5.png){fig-align="center" width="95%"}
...
![Drawing Mode allows the user to draw points, rectangles and polygons on flattened equirectangular images.](Images/Figure7.png){fig-align="center" width="95%"}
...
![Adding a record to the whole image marker. The process is the same for points, rectangles and polygons drawn on maps or 360-degree equirectangular images.](Images/Figure8.png){fig-align="center" width="95%"}
...
![Example help files for collection of ecological data from 360 degree images.](Images/Figure9.png){fig-align="center" width="95%"}
...
![Exported data file containing annotations appended to camera image metadata.](Images/Figure10.png){fig-align="center" width="95%"}
...
![Map generated using mapview.](Images/Figure11.png){fig-align="center" width="95%"}
...
![Relationship between number of plant species recorded in a field survey (x axis) and camera survey (y axis) of the same plots.](Images/Figure12.png){fig-align="center" width="95%"}
